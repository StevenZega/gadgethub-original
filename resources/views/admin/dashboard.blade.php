    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                ...
                <small class="text-penjelas">Kelola produk dan pantau statistik penjualan gadget</small>
            </div>
            <div>
        ...
        @else
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    <div class="card-modern">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="text-penjelas-label">Total Produk</h6>
                ...
                <div class="col-md-4">
                    <div class="card-modern">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="text-penjelas-label">Penjualan Hari Ini</h6>
                ...
                <div class="col-md-4">
                    <div class="card-modern">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="text-penjelas-label">Pesanan Masuk</h6>
            ...
            <div class="card-modern">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-4">
                    <div>
                        ...
                        <p class="text-penjelas mb-0">Kelola semua data produk dan pantau performa toko dengan tampilan modern.</p>
                    </div>
