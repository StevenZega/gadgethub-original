        ...
        <div class="row">
            <div class="col-md-5 pe-md-4 mb-4 mb-md-0">
                ...
                <div class="p-4 rounded-4" style="background: rgba(15, 23, 42, 0.3); border: 1px solid rgba(255,255,255,0.03);">
                    ...
                    <p class="text-slate-300 lh-base mb-0" style="font-size: 0.95rem; white-space: pre-line; opacity: 0.85;">{{ $product->description }}</p>
                </div>
            </div>
                ...
                <div class="row g-3 pt-3 border-top border-secondary border-opacity-20 mt-4">
                    <div class="col-sm-6">
                        <div class="p-3 rounded-4" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.08);">
                            ...
                            <div class="fs-3 fw-bold text-white">Rp {{ number_format($product->price, 0, ',', '.') }}</div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="p-3 rounded-4" style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.08);">
                            <small class="text-secondary d-block text-uppercase fw-bold small tracking-wider mb-1">Stok</small>
                            <div class="fs-3 fw-bold text-white">{{ $product->stock }} <span class="fs-6 text-white fw-normal">Unit</span></div>
                        </div>
                    </div>
                </div>
