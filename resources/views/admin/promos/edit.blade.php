    ...
    <div class="card-modern p-4">
        <div class="border-bottom border-secondary border-opacity-10 pb-3 mb-4">
            <h4 class="fw-bold mb-0 text-white">
                <i class="bi bi-pencil-square text-purple-400 me-2"></i> Edit Aturan Promo
            </h4>
        </div>
        ...
        <form action="{{ route('promos.update', $promo->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="code" class="form-control text-white text-uppercase" value="{{ old('code', $promo->code) }}" required style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold text-slate-300">Nama Event Promo</label>
                    <input type="text" name="name" class="form-control text-white" value="{{ old('name', $promo->name) }}" required style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="scope" id="scope" class="form-select text-white" onchange="kondisiFormPromo()" style="background: #1e293b; border-color: rgba(255,255,255,0.1);">
                        <option value="all" {{ old('scope', $promo->scope) == 'all' ? 'selected' : '' }}>Semua Produk (Universal / All Items)</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="discount_percent" class="form-control text-white" value="{{ old('discount_percent', $promo->discount_percent) }}" min="1" max="100" required style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                </div>
            </div>
            ...
            <div class="mb-3 {{ old('scope', $promo->scope) == 'category' ? '' : 'd-none' }}" id="input-kategori">
                ...
                <input type="text" name="category" class="form-control text-white" value="{{ old('category', $promo->category) }}" placeholder="Ketik kategori produk, misal: iPhone, Laptop" style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="start_date" class="form-control text-white" value="{{ old('start_date', $promo->start_date) }}" required style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold text-slate-300">Tanggal Kedaluwarsa</label>
                    <input type="date" name="end_date" class="form-control text-white" value="{{ old('end_date', $promo->end_date) }}" required style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                </div>
            </div>
